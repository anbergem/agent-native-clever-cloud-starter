...
```bash
$EDITOR migrations/0003_job_assignee_history.sql
```
...
The production workflow records what backups exist into the job summary before it migrates, and
